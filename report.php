  ...
  <div class="why-choose-us style2 gray-bg3 pt-100 pb-100 md-pt-70 md-pb-70">
          ...
          <div class="row container m-auto">
            ...
            <div class="col-lg-4 hidden-sm hidden-md mb-30">
              <img src="assets/images/water.jpg" alt="" class = "rounded-circle left-image " width="400" height="450">
              <div class="left-icon justify-content-right">
            ...
            <div class="col-lg-4 hidden-sm hidden-md mb-30">
              <div class="right-icon">
                <i class="fa fa-f214 fa-5x" style="color:#3498DB;"></i>
              </div>
              <img src="assets/images/laptop.jpg" alt="" class = "rounded-circle left-image " width="350" height="350">
            </div>
